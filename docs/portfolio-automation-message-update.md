# Portfolio Automation Message Update

Use this to replace or tighten the recurring automation prompt.
...
- Do not create a new standalone repo during ordinary runs.
- Do not add another small one-off CLI, browser demo, dashboard, simulator, lab, playground, or portfolio gimmick.
- Rare exception: after several runs of deliberation, you may create exactly one new project if it is meaningfully better than the existing portfolio work and cannot fit inside an existing repo. It should feel like a real product or serious technical artifact, not a prompt-shaped toy.
