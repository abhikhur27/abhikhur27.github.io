...
- `projects/status-page-voice-lab`: incident communication simulator for composing public status updates under uncertainty and watching wording shift trust, clarity, ticket load, and operator calm.
